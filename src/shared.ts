...
import { CommonConnectElementMethodConfig, ConnectElementCustomMethodConfig } from "../types/config";
...
export const initStripeConnect = (
  ...
  return {
    create: tagName => {
      ...
      const methods = { ...customMethods, ...CommonConnectElementMethodConfig};
